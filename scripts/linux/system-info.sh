...
if [[ "${1:-}" == "--help" || "${1:-}" == "-h" ]]; then
    echo "Usage: system-info.sh [TYPE]"
    echo ""
    echo "Display hardware information via dmidecode."
    echo ""
    echo "Types:"
    echo "  1 (Default) System information"
    echo "  0           BIOS information"
    echo "  2           Baseboard/Motherboard information"
    echo "  3           Chassis information"
